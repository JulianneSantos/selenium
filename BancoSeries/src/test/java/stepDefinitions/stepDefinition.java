...
public class stepDefinition {
	...
	public void preencher_os_dados_solicitados_pelo_site() throws InterruptedException {
		// Write code here that turns the phrase above into concrete actions
		ActionAcesso.preencheDados(driver, HomeMap.CAMPO_LOGIN, HomeMap.CAMPO_EMAIL, HomeMap.CAMPO_SENHA,
				HomeMap.CAMPO_CONFIRMAR_SENHA, HomeMap.CAMPO_LOGIN_MENU_LOGIN, HomeMap.CAMPO_SENHA_MENU_LOGIN);
	}

	@When("Clicar no botão {string}")
	public void clicar_no_botão(String string) {
		ActionAcesso.clicarBotao(driver);
	}

	@Then("Cadastro é realizado com sucesso")
	public void cadastro_é_realizado_com_sucesso() throws InterruptedException {
		ActionAcesso.validarCadastro(driver);
	}
